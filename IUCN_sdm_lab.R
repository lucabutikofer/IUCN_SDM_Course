# IUCN summer school 2022; Script for afternoon laboratory

# install and open packages. RUN ONLY ONCE!
...
# Biodiversity Data Journal 5: e20530. https://doi.org/10.3897/BDJ.5.e20530
...
# check coordinateCleaner for more tests https://besjournals.onlinelibrary.wiley.com/doi/10.1111/2041-210X.13152 
...
# ENMevaluate completed in 2 minutes 27 seconds. on Federico's laptop
...
# The package "red" (Cardoso 2017) allows data of three types: 
# 1) matrix of longitude and latitude (two columns) of each occurrence record; 
# 2) matrix of easting and northing (two columns, e.g. UTM) of each occurrence record in meters; 
# 3) RasterLayer object of predicted distribution (either 0/1 or probabilistic values).
